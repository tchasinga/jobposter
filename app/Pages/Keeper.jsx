...
import { FaFacebook, FaTelegram, FaWhatsapp, FaEnvelope, FaShareAlt } from 'react-icons/fa';
    ...
    >
      ...
      <div className='flex flex-col lg:flex-row items-center justify-center h-screen max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          >
            <button className="px-8 py-3 bg-white text-black font-mono rounded-lg hover:bg-white/90 transition-all duration-300 hover:scale-105">
              Browse Jobs
            </button>
        ...
        >
          {/* Main image */}
          <motion.div 
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 rounded-xl overflow-hidden shadow-2xl z-20"
          >
            <Image
              src={ImgTwo}
          ...
          {/* Left image */}
          <motion.div 
            className="absolute top-1/3 left-0 w-48 h-48 rounded-lg overflow-hidden shadow-xl border-2 border-white/50 z-10"
          ...
          {/* Right image */}
          <motion.div 
            className="absolute bottom-1/3 right-0 w-56 h-56 rounded-lg overflow-hidden shadow-xl z-10"
          >
            <Image
              src={ImgFour}
          ...
          <motion.div 
            className="absolute top-1/4 right-1/4 w-32 h-32 rounded-lg overflow-hidden shadow-lg border-2 border-white/30"
